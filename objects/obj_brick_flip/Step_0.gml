...
if (instance_exists(obj_playerparent)) {
    ...
    && (obj_playerparent.jumpstyle == 1) {
        ...
        //Create shards    
        shard_create(x+8, y+8, spr_shard_flip, 3, 6, 45);
        shard_create(x+8, y+8, spr_shard_flip, 1, 6, 60);
        shard_create(x+8, y+8, spr_shard_flip, 0, 6, 120);
        shard_create(x+8, y+8, spr_shard_flip, 2, 6, 135);
