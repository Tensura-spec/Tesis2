...
if (hspeed != 0) {
    ...
    || ((hspeed > 0) && (collision_rectangle(bbox_right+hspeed*3, bbox_top+4, bbox_right+hspeed*3, bbox_bottom-1, obj_solid, 0, 0))) {
    ...
    if ((hspeed < 0) && (collision_rectangle(bbox_left+hspeed, bbox_top+4, bbox_left+hspeed, bbox_bottom-1, obj_solid, 0, 0)))
        x++;
    if ((hspeed > 0) && (collision_rectangle(bbox_right+hspeed, bbox_top+4, bbox_right+1+hspeed, bbox_bottom-1, obj_solid, 0, 0)))
        x--;    
}
