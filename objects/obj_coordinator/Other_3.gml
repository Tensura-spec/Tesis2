...
#region SAVE SETTINGS
	...
	//Save 'Action 0' key
	file_text_write_string(file, string(global.key[input2.action_0]));
	file_text_writeln(file);

	//Save 'Action 1' key
	file_text_write_string(file, string(global.key[input2.action_1]));
	file_text_writeln(file);

	//Save 'Action 2' key
	file_text_write_string(file, string(global.key[input2.action_2]));
	file_text_writeln(file);
	...
	file_text_write_string(file, string(global.button[input2.action_0]));
	file_text_writeln(file);

	//Save 'Action 1' button
	file_text_write_string(file, string(global.button[input2.action_1]));
	file_text_writeln(file);

	//Save 'Action 2' button
	file_text_write_string(file, string(global.button[input2.action_2]));
	file_text_writeln(file);
