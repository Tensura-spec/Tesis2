...
//Otherwise if falling, land on ground
    ...
    if (gravity == 0) {
        ...
        with (instance_create(bbox_left, bbox_bottom, obj_smoke)) sprite_index = spr_smoke_32;
        with (instance_create(bbox_right, bbox_bottom, obj_smoke)) sprite_index = spr_smoke_32;
