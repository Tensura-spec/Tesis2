...
var overlap = collision_rectangle(bbox_left, bbox_top+4, bbox_right, bbox_bottom-4, obj_enemyparent, 0, 1);
if (overlap) 
...
var overlap2 = collision_rectangle(bbox_left, bbox_top+4, bbox_right, bbox_bottom-4, obj_holdparent_enemy, 0, 1);
if (overlap2) 
